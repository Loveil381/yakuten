...
const S: Record<string, CSSProperties> = {
  ...
  disclaimer: {
    ...
    border: '1px solid rgba(200, 75, 124, 0.4)',
    borderRadius: '8px',
  ...
  searchInput: {
    ...
    borderRadius: '8px',
    border: '1px solid rgba(200, 175, 190, 0.2)',
  ...
  filterBtnActive: {
    background: 'rgba(200, 75, 124, 0.25)',
    borderColor: 'rgba(200, 75, 124, 0.6)',
    color: 'var(--color-text-primary, #fff)',
  },
  stats: {
    fontSize: '0.75rem',
  ...
  badgeApproved: { background: 'rgba(40, 167, 69, 0.2)', color: '#5cb85c' },
  badgePrescription: { background: 'rgba(0, 123, 255, 0.2)', color: '#6aa8ff' },
  badgeGrey: { background: 'rgba(255, 193, 7, 0.2)', color: '#e0a800' },
  badgeBanned: { background: 'rgba(220, 53, 69, 0.25)', color: '#ff6b6b' },
  brandName: {
